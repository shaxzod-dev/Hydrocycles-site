...
const LikedItems = ({ data, card }) => {
  ...
  return (
    <div className="relative flex gap-x-5 border-4 w-[800px]  bg-white py-2 px-2 border-title-gray ">
      <div className="w-[102px] h-[90px]">
        <img src={data.image} alt={data.text} className="w-full h-full" />
      </div>
      <div className="flex flex-col">
        <h2 className="text-sm font-normal text-title-color">{data.text}</h2>
